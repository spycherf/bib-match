...
def main():
    ...
    # Box plots of score differences
    ...
    ax.add_patch(matplotlib.patches.Rectangle((0, 20), 23, 3, fill=False, edgecolor="blue", lw=1))
    ax.add_patch(matplotlib.patches.Rectangle((20, 0), 3, 23, fill=False, edgecolor="blue", lw=1))
    ...
    ax.set_xticklabels(xlabels, size=13)
    ax.set_yticklabels(ylabels, size=13)
    ax.add_patch(matplotlib.patches.Rectangle((0, 11), 12, 1, fill=False, edgecolor="blue", lw=1))
